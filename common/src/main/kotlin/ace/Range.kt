...
external interface RangeModule {
    @JsName("Range")
    val range: JsClass<Range>
}

fun JsClass<Range>.new(startRow: Int, startColumn: Int, endRow: Int, endColumn: Int): Range {
    return constructor4Arg(this, startRow, startColumn, endRow, endColumn)
}
